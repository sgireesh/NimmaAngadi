...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, BackHandler, Button, Platform } from 'react-native';
    ...
    notifyCustomer = async () => {
        try {
            ...
            if (this.state.setflag1 && this.state.setflag2) {
                var msg = "Your Order is ready. Pickup Time: " + this.state.date + " Price: " + this.state.totalcost;
...
/*
    onDateChange = (selectedDate) => {
        ...
        console.log("113: ", currentDate);
        //this.setState({ pickuptime: currentDate });
    };
        ...
        return (
            <View>
                ...
                <View >
                    ...
                    <View >
                        <Text style={styles.textGlobal}>Time : {this.state.date} </Text>
                    </View>
                    <View >
